export const aboutData = {
    ...
    mission: {
        ...
        p1: "GreenCart started with a simple observation: the disconnect between modern living and natural wisdom is growing. Our mission is to bridge this gap using cutting-edge Computer Vision and Weather Analytics.",
        p2: "We provide tools that help users identify plants instantly, receive climate-aware crop recommendations, and discover verified herbal alternatives for a healthier, more sustainable lifestyle.",
    ...
    stats: [
        ...
        { number: '5k+', label: 'Verified Products' },
        { number: '2k+', label: 'Happy Farmers' },
